...
enum
{
	...
	// fast dictionary operations (key required at compile time)
	OP_DICT_SET,
	OP_DICT_GET,
	OP_DICT_PAIRS,
	...
	// slower dictionary operations than OP_DICT_* but faster than OP_SETINDEX and OP_GETINDEX (key is not known at compile time; these ops are generated by intrinsics dict_get, dict_set) 
	OP_DICT_SET_RKEY,
	OP_DICT_GET_RKEY,
